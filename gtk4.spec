...
%prep
%setup -q -n gtk-4.10.0
cd %{_builddir}/gtk-4.10.0
pushd ..
cp -a gtk-4.10.0 buildavx2
popd
...
/usr/lib64/glibc-hwcaps/x86-64-v3/libgtk-4.so.1.1000.0
...
/usr/lib64/libgtk-4.so.1.1000.0
