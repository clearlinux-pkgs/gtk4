...
%prep
%setup -q -n gtk-4.8.2
cd %{_builddir}/gtk-4.8.2
pushd ..
cp -a gtk-4.8.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666827184
...
/usr/lib64/glibc-hwcaps/x86-64-v3/libgtk-4.so.1.800.2
