...
Source0  : https://download.gnome.org/sources/gtk/4.16/gtk-4.16.1.tar.xz
...
%prep
%setup -q -n gtk-4.16.1
cd %{_builddir}/gtk-4.16.1
pushd ..
cp -a gtk-4.16.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726772598
...
/V3/usr/lib64/libgtk-4.so.1.1600.1
...
/usr/lib64/libgtk-4.so.1.1600.1
