...
Source0  : https://download.gnome.org/sources/gtk/4.18/gtk-4.18.2.tar.xz
...
%prep
%setup -q -n gtk-4.18.2
cd %{_builddir}/gtk-4.18.2
pushd ..
cp -a gtk-4.18.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742857097
...
/V3/usr/lib64/libgtk-4.so.1.1800.2
...
/usr/lib64/libgtk-4.so.1.1800.2
