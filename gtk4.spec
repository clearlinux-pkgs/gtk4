...
%prep
%setup -q -n gtk-4.6.7
cd %{_builddir}/gtk-4.6.7
pushd ..
cp -a gtk-4.6.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661197524
...
/usr/lib64/glibc-hwcaps/x86-64-v3/libgtk-4.so.1.600.7
