...
Source0  : https://download.gnome.org/sources/gtk/4.16/gtk-4.16.12.tar.xz
...
%prep
%setup -q -n gtk-4.16.12
cd %{_builddir}/gtk-4.16.12
pushd ..
cp -a gtk-4.16.12 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736188597
...
/V3/usr/lib64/libgtk-4.so.1.1600.12
...
/usr/lib64/libgtk-4.so.1.1600.12
