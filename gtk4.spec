...
Source0  : https://download.gnome.org/sources/gtk/4.16/gtk-4.16.2.tar.xz
...
%prep
%setup -q -n gtk-4.16.2
cd %{_builddir}/gtk-4.16.2
pushd ..
cp -a gtk-4.16.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727190923
...
/V3/usr/lib64/libgtk-4.so.1.1600.2
...
/usr/lib64/libgtk-4.so.1.1600.2
