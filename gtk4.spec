...
Source0  : https://download.gnome.org/sources/gtk/4.18/gtk-4.18.6.tar.xz
...
%prep
%setup -q -n gtk-4.18.6
cd %{_builddir}/gtk-4.18.6
pushd ..
cp -a gtk-4.18.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749667588
...
/V3/usr/lib64/libgtk-4.so.1.1800.6
...
/usr/lib64/libgtk-4.so.1.1800.6
