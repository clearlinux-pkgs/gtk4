...
Source0  : https://download.gnome.org/sources/gtk/4.12/gtk-4.12.4.tar.xz
...
%prep
%setup -q -n gtk-4.12.4
cd %{_builddir}/gtk-4.12.4
pushd ..
cp -a gtk-4.12.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1703206802
...
/V3/usr/lib64/libgtk-4.so.1.1200.4
...
/usr/lib64/libgtk-4.so.1.1200.4
