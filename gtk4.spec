...
Source0  : https://download.gnome.org/sources/gtk/4.14/gtk-4.14.2.tar.xz
...
%prep
%setup -q -n gtk-4.14.2
cd %{_builddir}/gtk-4.14.2
pushd ..
cp -a gtk-4.14.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712159832
...
/V3/usr/lib64/libgtk-4.so.1.1400.2
...
/usr/lib64/libgtk-4.so.1.1400.2
