...
Source0  : https://download.gnome.org/sources/gtk/4.18/gtk-4.18.3.tar.xz
...
%prep
%setup -q -n gtk-4.18.3
cd %{_builddir}/gtk-4.18.3
pushd ..
cp -a gtk-4.18.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743436873
...
cp %{_builddir}/gtk-%{version}/subprojects/pango/COPYING %{buildroot}/usr/share/package-licenses/gtk4/bf50bac24e7ec325dbb09c6b6c4dcc88a7d79e8f || :
GOAMD64=v3
...
/usr/share/glib-2.0/schemas/org.gtk.gtk4.Inspector.gschema.xml
...
/V3/usr/lib64/libgtk-4.so.1.1800.3
...
/usr/lib64/libgtk-4.so.1.1800.3
...
/usr/share/package-licenses/gtk4/bf50bac24e7ec325dbb09c6b6c4dcc88a7d79e8f
