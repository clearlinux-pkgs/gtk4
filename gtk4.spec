...
%prep
%setup -q -n gtk-4.18.5
cd %{_builddir}/gtk-4.18.5
pushd ..
cp -a gtk-4.18.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746463595
...
/V3/usr/lib64/libgtk-4.so.1.1800.5
...
/usr/lib64/libgtk-4.so.1.1800.5
